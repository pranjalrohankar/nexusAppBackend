    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/courses/*/covered-topics", "/api/courses/by-title/covered-topics").permitAll()
                ...
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/batches/*/covered-topics").permitAll()
